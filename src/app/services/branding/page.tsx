...
export const metadata: Metadata = {
  title: "Branding & Creative Design | Iconic Identity | TopRank Digital",
  description: "Iconic brand identity and creative design that makes your business unforgettable. Logo, Visual ID, and Ad Creatives.",
};
...
export default function BrandingPage() {
  return (
    <main className="min-h-screen bg-slate-50 flex flex-col">
      <section className="pt-32 pb-20 bg-white relative overflow-hidden">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
          <div className="max-w-3xl">
            <div className="inline-flex items-center gap-2 px-3 py-1 bg-purple-50 border border-purple-100 rounded-full text-purple-600 text-[10px] font-black uppercase tracking-widest mb-6">
            ...
            <p className="text-lg md:text-xl text-slate-600 font-medium leading-relaxed mb-10">
              Iconic brand identity and creative design that makes your business unforgettable in the market. Command higher prices with premium design.
            </p>
            <Link href="/contact" className="px-8 py-4 bg-slate-900 text-white rounded-2xl font-black uppercase text-xs tracking-widest hover:bg-black transition-all shadow-xl shadow-slate-900/20 active:scale-95 inline-flex items-center gap-2">
              Design My Brand <ArrowRight className="w-4 h-4" />
            </Link>
          </div>
        </div>
      </section>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
            <div className="space-y-8">
              <h2 className="text-3xl font-black text-slate-900 tracking-tight">Visual Identity Mastery</h2>
              <p className="text-slate-600 font-medium leading-relaxed">
                Your visual identity is the first thing a customer experiences. We ensure it communicates authority, trust, and premium quality across every touchpoint.
              </p>
              <div className="space-y-4">
                {[
                  "Iconic Logo & Core Identity",
                  "Viral Social Media Creative Suite",
                  "High-CTR Performance Ad Designs",
                  "Complete Brand Methodology",
      ...
      <RelatedServices currentServiceId="branding" />
      <Footer />
    </main>
  );
}
