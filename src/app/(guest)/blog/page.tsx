      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10 w-full">
        ...
        <div className="text-center max-w-3xl mx-auto mb-16 lg:mb-24">
          <div className="inline-flex items-center space-x-2 bg-white px-4 py-2 rounded-full border border-slate-200/60 shadow-sm mb-6">
             ...
             <span className="text-[11px] font-bold text-slate-600 uppercase tracking-wider">Latest Insights</span>
          </div>
          <h1 className="text-5xl lg:text-6xl font-black text-slate-900 leading-[1.1] tracking-tight mb-6">
            The TopRank <span className="text-transparent bg-clip-text bg-gradient-to-r from-orange-500 via-pink-500 to-blue-600">Growth Blog</span>
          </h1>
          <p className="text-lg text-slate-600 leading-relaxed">
            Master the digital landscape with deep dives, insider strategies, and real-world tactics to dominate your local market.
          </p>
        </div>
              ...
              <Link key={post.id} href={`/blog/${post.slug}`} className="group h-full">
                <article className="h-full bg-white rounded-2xl shadow-[0_10px_30px_-15px_rgba(0,0,0,0.05)] hover:shadow-[0_20px_40px_-15px_rgba(0,0,0,0.12)] border border-slate-200/60 hover:border-blue-200 overflow-hidden hover:-translate-y-1 transition-all duration-300 flex flex-col relative z-20">
                  ...
                  <div className="p-6 sm:p-8 flex-1 flex flex-col relative">
                    ...
                    <h2 className="text-2xl font-black text-slate-900 mb-3 line-clamp-2 leading-tight group-hover:text-blue-600 transition-colors">
                      {post.title}
                    </h2>
                    ...
                    <div className="mt-auto pt-6 border-t border-slate-100 flex items-center justify-between text-[14px] font-bold text-slate-900 group-hover:text-blue-600 transition-colors">
                      Read Article
                      <div className="bg-slate-50 group-hover:bg-blue-50 p-2 rounded-full transition-colors">
          ...
          <div className="flex justify-center items-center gap-4">
            {page > 1 ? (
              <Link
                ...
                className="px-6 py-3 bg-white border border-slate-200 text-slate-700 hover:text-blue-600 hover:border-blue-200 rounded-xl shadow-sm transition-all font-bold text-sm"
              >
                Previous
              </Link>
            ) : (
            ...
            {page < totalPages ? (
              <Link
                href={`/blog?page=${page + 1}`}
                className="px-6 py-3 bg-white border border-slate-200 text-slate-700 hover:text-blue-600 hover:border-blue-200 rounded-xl shadow-sm transition-all font-bold text-sm flex items-center"
              >
                Next
              </Link>
            ) : (
